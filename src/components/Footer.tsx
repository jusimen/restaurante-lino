    ...
    <footer className="bg-espresso text-cream/85" style={{ background: "oklch(0.22 0.025 40)" }}>
      <Container className="py-16">
        <div className="grid gap-12 md:grid-cols-3">
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2 text-sm">
              ...
              <li>
                <a href={`${home === "/" ? "" : home}#about`} className="hover:text-white">
                  {t("nav.about")}
                </a>
              </li>
              <li>
              ...
              <li>
                <a href={`${home === "/" ? "" : home}#contact`} className="hover:text-white">
                  {t("nav.contact")}
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="mt-5 flex gap-3">
              <a
                href="https://www.instagram.com/restaurant_lino"
              ...
              <a
                href="https://www.facebook.com/RestauranteLino2026"
                aria-label="Facebook"
                className="rounded-full border border-white/20 p-2 hover:bg-white/10 transition-colors"
              >
        ...
        <div className="mt-12 pt-6 border-t border-white/10 flex flex-col md:flex-row justify-between gap-2 text-xs text-white/50">
          <p>
            © {year} Restaurante Lino. {t("footer.rights")}
          </p>
